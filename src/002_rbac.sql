...
CREATE TABLE Projects (
    ...
    managerID INTEGER REFERENCES Users(userID) ON DELETE SET NULL,
...
CREATE TABLE Forms (
    ...
    previous_formID INTEGER REFERENCES Forms(formID) ON DELETE SET NULL,
...
CREATE INDEX idx_forms_fields_definition_gin
    ON Forms USING GIN(fields_definition);
